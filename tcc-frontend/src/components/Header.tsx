...
export default function Header() {
    ...
    return (
        <div className="font-pressStart w-full h-16 bg-vibratingBlue text-textBlack flex justify-between items-center fixed top-0 left-0 right-0 z-50">
            ...
            <div className="flex justify-evenly items-center w-1/3 text-primaryWhite">
                <span onClick={handleHomeClick} className="cursor-pointer">
                    <NavItem>Início</NavItem>
                </span>
                <span onClick={() => navigate('/Tutorial')} className="cursor-pointer">
